...
#
# Script generated by Vivado on Thu Aug 14 11:42:06 -0500 2025
# SW Build 6140274 on Thu May 22 00:12:29 MDT 2025
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2025 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : led_system.sh
...
#
# Usage        : led_system.sh
#                led_system.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                led_system.sh [-reset_run]
#                led_system.sh [-reset_log]
#                led_system.sh [-help]
#
...
# script info
echo -e "led_system.sh - Script generated by export_simulation (Vivado v2025.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./led_system.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L processing_system7_vip_v1_0_23 -L proc_sys_reset_v5_0_17 -L xlconstant_v1_1_10 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot led_system xil_defaultlib.led_system xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim led_system -key {Behavioral:sim_1:Functional:led_system} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_287e.protoinst" -protoinst "protoinst_files/led_system.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb led_system.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./led_system.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: led_system.sh [-help]\n\
Usage: led_system.sh [-step]\n\
Usage: led_system.sh [-lib_map_path]\n\
Usage: led_system.sh [-reset_run]\n\
Usage: led_system.sh [-reset_log]\n\
Usage: led_system.sh [-keep_index]\n\
Usage: led_system.sh [-noclean_files]\n\n\
