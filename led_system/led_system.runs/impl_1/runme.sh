...
HD_PWD='C:/Users/micha/led_system/led_system.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log led_system_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source led_system_wrapper.tcl -notrace
