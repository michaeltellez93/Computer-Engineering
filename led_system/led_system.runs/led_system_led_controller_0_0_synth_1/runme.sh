...
HD_PWD='C:/Users/micha/led_system/led_system.runs/led_system_led_controller_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log led_system_led_controller_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source led_system_led_controller_0_0.tcl
