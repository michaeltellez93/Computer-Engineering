...
-- Date        : Thu Aug 14 11:44:04 2025
-- Host        : The_Pwnerer1337 running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode synth_stub -rename_top led_system_axi_smc_0 -prefix
--               led_system_axi_smc_0_ led_system_axi_smc_0_stub.vhdl
-- Design      : led_system_axi_smc_0
...
entity led_system_axi_smc_0 is
  Port ( 
    aclk : in STD_LOGIC;
  ...
  attribute CHECK_LICENSE_TYPE of led_system_axi_smc_0 : entity is "led_system_axi_smc_0,bd_287e,{}";
  attribute CORE_GENERATION_INFO : string;
  attribute CORE_GENERATION_INFO of led_system_axi_smc_0 : entity is "led_system_axi_smc_0,bd_287e,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=ip,x_ipName=smartconnect,x_ipVersion=1.0,x_ipCoreRevision=27,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of led_system_axi_smc_0 : entity is "yes";
end led_system_axi_smc_0;

architecture stub of led_system_axi_smc_0 is
  ...
  attribute X_INTERFACE_PARAMETER of aclk : signal is "XIL_INTERFACENAME CLK.aclk, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN led_system_processing_system7_0_0_FCLK_CLK0, ASSOCIATED_BUSIF M00_AXI:S00_AXI, INSERT_VIP 0, ASSOCIATED_CLKEN s_sc_aclken";
  ...
  attribute X_CORE_INFO of stub : architecture is "bd_287e,Vivado 2025.1";
begin
end;
